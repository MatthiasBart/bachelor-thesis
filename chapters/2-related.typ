...
Already back 2001 the Proem project @peertopeermobile examined different aspects of peer-to-peer applications for ad hoc networks. They already noticed the trend for a ever-larger becoming applicability of personal mobile devices for data sharing but listed resources of mobile devices among other possible limitations. This facet has fastly changed since then and several new ideas like ShAir @shair, a middleware infrasructure for peer-to-peer sharing between mobile devices or mFerio @mFerio, a peer-to-peer mobile payment system have emerged. The working group of mFerio already noticed the problem that mobile devices rely too heavily on static infrastructure. Fortunately hardware of modern smartphones has matured and has gotten support for Bluetooth, WiFi Direct and Apple's Multipeer Connectivity, which were used by #cite(<gossip>, form: "author") in his approach to develop a new gossip algorithm for a local peer to peer communication system @gossip. Though approaches existed to also introduce LTE-Direct, no support for this technology is given on mobile smartphones @ltedirect. This is why this thesis will focus on the available technologies WiFi-Direct and Bluetooth, which work under the hood of Apple's Multipeer Connectivity. 
