...
As of 2024 4 billion people worldwide are carrying smartphones @statista_research_department_number_2024 with them. Twenty seven percent of them are developed and manufactured by one of the most valuable companies in the world. Since 2007, when the first iPhone was released on 27th of June Apple has sold more than 2.8 billion devices @sherif_apple_2025. This makes #gls("ios") one of the most used mobile operating systems worldwide with a current market share of 27% @ahmed_sherif_market_2025. #gls("ios") also utilizes its own implementation of a #gls("ptp") WiFi protocol which is strongly used by Apples Continuity @apple_inc_continuity_2024 which bundles applications like AirDrop or AirPlay, Universal Clipboard, Handoff or WiFi password sharing for contacts that want to join your network. 
...
After all the described aspects have been taken into consideration, the Networking Framework, included in the #gls("ios") #gls("sdk") is used to establish and test the quality of #gls("ptp") #gls("awdl") connections between #gls("ios") devices. The tests will alternate using TCP, UDP and QUIC in different surroundings that represent typical locations, varying in crowd density or general ambient #gls("rfemf") levels.
...
Which aspects influence the #gls("ptp") #gls("awdl") connection quality on #gls("ios") devices and how far can it reach?
...
Nowadays Smartphones mostly rely on infrastructure networks. As this is a strong dependency that could vastly limit access and advancements in #gls("ptp") connection soft- and hardware have emerged in recent years it is unclear which connection qualities these methods can produce. Therefore a prototype application developed for the #gls("ios") platform serves as a utility for measuring  selected metrics.
